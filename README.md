...
**An AI-powered Deep Ocean Pollution & Biodiversity Monitoring Platform** — a cinematic, immersive, Awwwards-level web experience built for a national frontend hackathon.

Think *Apple × OceanX × BBC Blue Planet*: a living 3D ocean you scroll, explore, and dive into.

> **Note:** This is a frontend-only experience. All data shown (species, pollution stats, discoveries, AI predictions) is realistic mock data — there is no live backend/DB/API wired up yet.
...
| Category | Stack |
|---|---|
| Core | React 19 (Create React App + CRACO) |
...
| Data viz | Recharts |
| Audio | Synthesized WebAudio ambient sound (muted by default) |
...
- **Palette:** deep navy → ocean blue → abyss blue background gradient, with bioluminescent cyan (`#00F0FF`), turquoise, sea-green, amber, and coral-red accents.
...
Full tokens live in [`design_guidelines.json`](./design_guidelines.json).
